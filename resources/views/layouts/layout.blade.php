        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Custom Quản lý User:</h6>
                    <a class="collapse-item" href="{{ route('courses.index') }}">Danh sách User</a>
                    <a class="collapse-item" href="{{ route('courses.create') }}">Thêm mới User</a>
                </div>
            </div>
        </li>
